...
public class AgendaPage extends DefaultPageMenu {
    ...
    protected void criarAbaComiteAssinaturaPendente() {
        PanelCachingTab panelCachingTab =
                new PanelCachingTab(new AbstractTab(new Model<String>("Comitês com assinatura de ata pendente")) {
    ...
    protected void criarAbaComiteAtaAssinada() {
        PanelCachingTab panelCachingTab =
                new PanelCachingTab(new AbstractTab(new Model<String>("Comitês com ata assinada")) {
