...
public class PerfilConsultaResumidoPage extends DefaultPageMenu {
    ...
    protected void onInitialize() {
        ...
        form.add(new PainelParametrosConsultaResumido("painelParametros", consultaParametro, consultaResultado));
        panielConsultaEsAtiva = new PainelResultadoConsultaEsAtiva("painelResultado", consultaResultado, false);
