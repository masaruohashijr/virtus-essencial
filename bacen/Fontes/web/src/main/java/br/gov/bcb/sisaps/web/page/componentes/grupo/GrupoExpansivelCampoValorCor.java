...
public class GrupoExpansivelCampoValorCor extends Panel {
    ...
    public GrupoExpansivelCampoValorCor(String id, String nomeCampo, String valorCampo, boolean expandido,
