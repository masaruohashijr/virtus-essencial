 ...
 */
public class RelatorioSlideConstante extends RelatorioSlideAbstrato {
    ...
    public RelatorioSlideConstante(SecaoApresentacaoEnum secao, ApresentacaoVO apresentacaoVO, int qtdPaginas,
            int indice) {
        super(secao, apresentacaoVO, false, qtdPaginas, indice);
        converterDados();
    }
    ...
    protected void adicionarParametros(Map<String, Object> parametrosJasper, Page paginaAtual) {
        ...
        parametrosJasper.put("conteudo", secao.getDescricao());
