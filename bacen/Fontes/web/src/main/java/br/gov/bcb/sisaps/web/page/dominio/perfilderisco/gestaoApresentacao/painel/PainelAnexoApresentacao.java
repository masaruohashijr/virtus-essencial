...
public class PainelAnexoApresentacao extends PainelCampoApresentacao {
    ...
    // Construtor
    public PainelAnexoApresentacao(String id, ApresentacaoVO apresentacaoVO, CampoApresentacaoEnum campo) {
        super(id, apresentacaoVO, campo);
        setOutputMarkupId(true);

        // Monta os componentes.
        montarComponentes(campo, apresentacaoVO);
    }

    // Monta os componentes do painel.
    private void montarComponentes(final CampoApresentacaoEnum campo, final ApresentacaoVO apresentacaoVO) {
