 ...
 */
public class RelatorioSlide13 extends RelatorioSlideAbstrato {
     ...
     */
    public static final String NOME_ARQUIVO_RELATORIO = "slide13";

    private static final String NOME_ARQUIVO_JASPER = "/relatorios/apresentacao/slide13.jasper";
    ...
    public RelatorioSlide13(SecaoApresentacaoEnum secao, ApresentacaoVO apresentacaoVO, int qtdPaginas, int indice,
            PerfilRisco perfilRiscoAtual, QuadroPosicaoFinanceiraVO quadroVO) {
    ...
    private void montarListaResultadosNovo() {
        if (CollectionUtils.isNotEmpty(quadroVO.getNomesResultados())) {
            List<OutraInformacaoVO> resultados =
                    quadroVO.getResultadosPorNome().get(quadroVO.getNomesResultados().get(0));
