...
WORKFLOW_NAME=WKF_QUANTITATIVA

# Define os arquivos de log da sessao e do workflow
# No caso dos logs de sessao podem ser definidos mais de um.
ListaLogsSessao="/pcenter/SessLogs/$FOLDER_NAME/s_MPP_QUANT_1_DBE.log
/pcenter/SessLogs/$FOLDER_NAME/s_MPP_QUANT_2_CAQ1.log
/pcenter/SessLogs/$FOLDER_NAME/s_MPP_QUANT_2_OIA.log
/pcenter/SessLogs/$FOLDER_NAME/s_MPP_QUANT_3_CAQ_OpC.log
/pcenter/SessLogs/$FOLDER_NAME/s_MPP_QUANT_4_EAQ.log"
