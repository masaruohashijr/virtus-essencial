package crt2.dominio.agenda.listarcomitesatapendente;
...
public class TestR001ListarComitesAtaPendente extends ConfiguracaoTestesNegocio {

    public List<ParticipanteAgendaCorec> getComitesAssinaturaAtaPendente() {
