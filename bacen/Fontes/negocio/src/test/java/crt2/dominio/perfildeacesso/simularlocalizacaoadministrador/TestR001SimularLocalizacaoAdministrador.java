...
public class TestR001SimularLocalizacaoAdministrador extends ConfiguracaoTestesNegocio {

    public List<CicloVO> consultaPainelSupervisor() {
        UsuarioAplicacao usuario = (UsuarioAplicacao) (UsuarioCorrente.get());

        ConsultaCicloVO consulta = new ConsultaCicloVO();
        consulta.setPerfil(PerfilAcessoEnum.SUPERVISOR);
