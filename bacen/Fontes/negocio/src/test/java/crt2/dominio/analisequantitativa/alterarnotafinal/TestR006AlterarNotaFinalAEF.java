...
public class TestR006AlterarNotaFinalAEF extends ConfiguracaoTestesNegocio {
    ...
    public String salvar(Integer idCiclo, String nota, String justificativa) {
        ...
        if (nota.equals("&ltRemover ajuste>")) {
            ...
            notaAQT = ParametroNotaAQTMediator.get().buscarPorDescricao(ciclo.getMetodologia(), nota);
