...
public class PluginExercicioFuncaoComissionada extends AbstractPluginObject {
    ...
    protected void action(IContext context, Object instance, RowAdapter row, IResultSet result) throws Exception {
        ...
        bean.incluirExercicioFuncaoComissionada((ExercicioFuncaoComissionadaVO) instance);
    }
}