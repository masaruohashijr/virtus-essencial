...
func createMembros() {
	sql := "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERSP' AND a.username = 'alessandro' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	...
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERRJ' AND a.username = 'carlos.silveira' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	...
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERRS' AND a.username = 'charles.silva' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	...
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERSP' AND a.username = 'clovis' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	...
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERMG' AND a.username = 'david' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	...
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERSP' AND a.username = 'diogo' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	...
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERRJ' AND a.username = 'eduardo' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERRJ' AND a.username = 'eliane' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	...
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERSP' AND a.username = 'estevam' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	...
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERPE' AND a.username = 'francisco.coelho' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	...
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERRJ' AND a.username = 'germano' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	...
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERSP' AND a.username = 'isabel' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	...
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERDF' AND a.username = 'juliana' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERDF' AND a.username = 'leonardo' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	...
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERRJ' AND a.username = 'marcelo' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERRJ' AND a.username = 'marcia' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	...
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERMG' AND a.username = 'maria.silva' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERRJ' AND a.username = 'maria.pimenta' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	...
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERDF' AND a.username = 'mauricio' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	...
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERRJ' AND a.username = 'maury' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	...
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERPE' AND a.username = 'otavio' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	...
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERRJ' AND a.username = 'pedro.eugenio' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERSP' AND a.username = 'peterson' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	...
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERRS' AND a.username = 'raquel' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	...
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERSP' AND a.username = 'roberto' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	...
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERSP' AND a.username = 'wander' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
	sql = "INSERT INTO virtus.membros (id_usuario, id_escritorio) SELECT a.id_user, b.id_escritorio FROM virtus.users a, virtus.escritorios b WHERE b.abreviatura = 'ERMG' AND a.username = 'wania' AND NOT EXISTS (SELECT 1 FROM virtus.membros c WHERE c.id_usuario = a.id_user and c.id_escritorio = b.id_escritorio )"
	db.Exec(sql)
