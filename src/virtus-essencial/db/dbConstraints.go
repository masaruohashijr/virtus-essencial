...
func createUniqueKey() {
	db.Exec(" IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = " +
		" OBJECT_ID(N'action_status_unique_key') AND type in (N'UQ')) BEGIN " +
	...
	db.Exec(" IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = " +
		" OBJECT_ID(N'tipos_notas_componentes_unique_key') AND type in (N'UQ')) BEGIN " +
	...
	db.Exec(" IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = " +
		" OBJECT_ID(N'produtos_planos_unique_key') AND type in (N'UQ')) BEGIN " +
	...
	db.Exec(" IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = " +
		" OBJECT_ID(N'produtos_tipos_notas_unique_key') AND type in (N'UQ')) BEGIN " +
	...
	db.Exec(" IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = " +
		" OBJECT_ID(N'produtos_elementos_unique_key') AND type in (N'UQ')) BEGIN " +
	...
	db.Exec(" IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = " +
		" OBJECT_ID(N'produtos_itens_unique_key') AND type in (N'UQ')) BEGIN " +
...
func createPKey() {
	db.Exec("IF NOT EXISTS (SELECT 1 FROM sys.objects WHERE object_id = " +
		" OBJECT_ID(N'status_membros_fkey') AND type in (N'PK')) BEGIN " +
