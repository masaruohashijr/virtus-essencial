...
class Membro {
	constructor(order, id, escritorioId, usuarioId, usuarioNome, usuarioPerfil, subordinacaoId, iniciaEm, terminaEm, autorId, autorNome, criadoEm, idVersaoOrigem, statusId, cStatus) {
		this.order = order;
		this.id = id;
		...
		this.subordinacaoId = subordinacaoId;
